      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-[#232946] rounded-lg p-8 mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-[#FFD700] font-semibold mb-2">How do I get my eBook after purchase?</h3>
              <p className="text-[#C0C0C0]">You'll receive an instant download link via email immediately after payment confirmation.</p>
            </div>
            <div>
              <h3 className="text-[#FFD700] font-semibold mb-2">What format is the eBook in?</h3>
              <p className="text-[#C0C0C0]">The eBook comes as a high-quality PDF that works on all devices - phones, tablets, and computers.</p>
            </div>
            <div>
              <h3 className="text-[#FFD700] font-semibold mb-2">Is this book suitable for beginners?</h3>
              <p className="text-[#C0C0C0]">Absolutely! The book is written to be accessible to readers of all levels, from complete beginners to experienced practitioners.</p>
            </div>
            <div>
              <h3 className="text-[#FFD700] font-semibold mb-2">Do I need any special software to read it?</h3>
              <p className="text-[#C0C0C0]">No special software needed! Any PDF reader will work, and most devices have one built-in.</p>
            </div>
          </div>
        </div>
        ...
        {/* Final CTA */}
        <div className="text-center">
          <h2 className="text-3xl md:text-4xl font-serif text-[#FFD700] font-bold mb-6">
            Ready to Begin Your Journey?
          </h2>
          <p className="text-xl text-[#C0C0C0] mb-8 max-w-2xl mx-auto">
            Join thousands of readers who have already discovered the profound wisdom and insights offered in our mystical knowledge collection.
          </p>
          <button
            onClick={() => handlePurchase(selectedBook)}
            disabled={loading}
            className="bg-gradient-to-r from-[#FFD700] to-[#FFED4E] text-[#191970] py-4 px-12 rounded-lg font-bold text-xl hover:from-[#FFED4E] hover:to-[#FFD700] transition-all transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? 'Processing...' : `🌟 Get ${selectedBook.title.split(':')[0]} for $4.99 🌟`}
          </button>
        </div>
      </div>
    </div>
